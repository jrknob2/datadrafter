...
export class ModelerWorkspaceComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    this.envInjector.runInContext(() => {
      const { component, inputs } = this.viewService.view.workspace;

      // Optional: skip creation if model is missing
